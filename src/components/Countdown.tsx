...
export default function Countdown() {
  ...
  return (
    ...
    >
      <h2 className="text-3xl font-serif mb-10 text-gray-800">
        Counting down to our big day
      </h2>

      <div className="flex flex-wrap justify-center gap-10 text-gray-900">
        {Object.entries(timeLeft).map(([unit, value]) => (
          ...
          >
            ...
            <div className="uppercase text-sm text-gray-600 mt-1 tracking-wide">
              {unit}
            </div>
          </div>
        ))}
